...
Каноническое описание учёта, отмен и проверок: [план адаптера, §6.5](github_projects_adapter_plan.md#65-согласованные-бюджеты-пилота-и-повторы--2026-09-16). Это утверждённые требования, **не уже реализованные ограничения**. Их распределение: PR-04 — timeout CI; PR-06 — store/резервы; PR-07 — сверка run/attempt; PR-08 — время и остановки; PR-09 — ограниченные повторы; PR-10 — решения оператора.
